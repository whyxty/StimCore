...
| `ОП` | отношение продуктивности `K_ф / K_пот` | – |
...
| `k_ms = m_s/m_0` | прирост пористости после СКО (лаб.) | – |
| `k_mg = m_g/m_s` | прирост пористости после ГКО (лаб.) | – |
| `k_msg = k_ms·k_mg` | суммарный прирост пористости | – |
| `C_к` | карбонатность породы | % |
| `C_к.пр` | минимальная карбонатность для СКО | % |
| `k_в.о = h_пгл/h_эф` | коэффициент охвата разреза по вертикали | – |
""")
